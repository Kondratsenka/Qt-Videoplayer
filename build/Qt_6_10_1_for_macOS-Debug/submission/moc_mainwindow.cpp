...
template <> constexpr inline auto MainWindow::qt_create_metaobjectdata<qt_meta_tag_ZN10MainWindowE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        // Slot 'on_btn_choose_clicked'
        QtMocHelpers::SlotData<void()>(1, 2, QMC::AccessPrivate, QMetaType::Void),
        // Slot 'on_position_changed'
        QtMocHelpers::SlotData<void(qint64)>(3, 2, QMC::AccessPrivate, QMetaType::Void, {{
            { QMetaType::LongLong, 4 },
        }}),
        // Slot 'on_media_status_changed'
        QtMocHelpers::SlotData<void(QMediaPlayer::MediaStatus)>(5, 2, QMC::AccessPrivate, QMetaType::Void, {{
            { 0x80000000 | 6, 7 },
        }}),
        // Slot 'on_playback_state_changed'
        ...
        // Slot 'on_sld_volume_valueChanged'
        QtMocHelpers::SlotData<void(int)>(12, 2, QMC::AccessPrivate, QMetaType::Void, {{
            { QMetaType::Int, 13 },
        }}),
        // Slot 'on_sld_pos_valueChanged'
